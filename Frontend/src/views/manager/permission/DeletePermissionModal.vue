<template>
  <Modal
    ...
    @modal-action-event="deletePermission"
  >
    ...
    <template v-slot:body v-if="data">
      <div class="text-center">
        <p class="mb-0 fs-5 text-center text-danger fw-medium">
          <span>Are you sure you want to delete the permission</span>
...
const modalId = 'delete-permission'
...
async function deletePermission() {
  ...
  try {
    ...
    const response = await fetchData(
      APIs.permissionDelete.url,
      true,
      params,
      null,
      null,
      APIs.permissionDelete.method
    )
